...
- Host/admin actions require a private host token generated by the desktop app instead of trusting localhost-style headers.
- Guest project tokens are revoked when the host stops a session.
