...
Version `0.1.26` adds explicit Viewer and Maintainer guest controls, stronger live-session authorization, detailed Help and About guidance, smoother desktop interactions, provider-aware AI context handling, and broader rendered and security regression coverage.
